...
export default function LandingPage() {
  ...
  const openSocial = (webUrl, appScheme) => {
    if (appScheme && /Android|iPhone|iPad/i.test(navigator.userAgent)) {
    ...
    <div className="min-h-screen relative overflow-x-hidden">
      ...
      <footer style={{ borderTop: "1px solid rgba(0,88,190,0.1)", padding: "32px 24px", textAlign: "center", position: "relative", zIndex: 1 }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "16px", marginBottom: "12px", flexWrap: "wrap" }}>
          ...
          <a href="#" onClick={e => { e.preventDefault(); openSocial("https://www.instagram.com/vishnuu__.__", "instagram://user?username=vishnuu__.__"); }}
            style={{ display: "flex", alignItems: "center", gap: "6px", fontSize: "13px", fontWeight: 600, color: "#727785", textDecoration: "none", padding: "6px 12px", borderRadius: "20px", border: "1px solid #e1e2e4", transition: "all 0.2s", cursor: "pointer" }}
          ...
          <a href="#" onClick={e => { e.preventDefault(); openSocial("https://youtube.com/@sasukex21yt", "youtube://www.youtube.com/@sasukex21yt"); }}
            style={{ display: "flex", alignItems: "center", gap: "6px", fontSize: "13px", fontWeight: 600, color: "#727785", textDecoration: "none", padding: "6px 12px", borderRadius: "20px", border: "1px solid #e1e2e4", transition: "all 0.2s", cursor: "pointer" }}
          ...
          <a href="#" onClick={e => { e.preventDefault(); openSocial("https://github.com/Vishnuu21", "github://github.com/Vishnuu21"); }}
            style={{ display: "flex", alignItems: "center", gap: "6px", fontSize: "13px", fontWeight: 600, color: "#727785", textDecoration: "none", padding: "6px 12px", borderRadius: "20px", border: "1px solid #e1e2e4", transition: "all 0.2s", cursor: "pointer" }}
          ...
          {/* 
          <a href="#" onClick={e => { e.preventDefault(); openSocial("https://linkedin.com/in/YOUR_LINKEDIN", "linkedin://in/YOUR_LINKEDIN"); }}
